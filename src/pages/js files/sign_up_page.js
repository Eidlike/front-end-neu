...
const tele=telee.current.value
  ...
  try{ const respons = await fetch('http://localhost:5000/newregistering',{
    ...
    return(
        ...
        <div className='sign_up_form_text' ><h1> Please fill out the following information to set up your free account. Let's get started</h1> </div> 
...
<div className='sign_up_form'>
     <form className="sign_up_form" onSubmit={submittt}> 
        ...
        <div> <label name='sexe_label'>Sexe: </label>
        ...
        <div className='adress' ><input ref={adresse} name='Address' type='text' placeholder='Adress' required></input> </div>
        ...
        <div className='have_account'> you already have an account? <a href='/login'>Login now</a></div>
